...
final class LogsSystemInteractor {
    ...
    func logsData() -> Logs {
        ...
        let fields = Fields(wssGoal: Int(settings.wss_goal),
                             ...
                             appBundleBuildVersion: Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "",
                             appBundleBuildNumber: Bundle.main.infoDictionary?["CFBundleVersion"] as? String ?? "",
